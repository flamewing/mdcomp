...
[![CI Windows MinGW](https://img.shields.io/github/actions/workflow/status/flamewing/mdcomp/ci-windows.yml?branch=master&label=CI%20Windows%20MinGW&logo=mingww64&logoColor=white)](https://github.com/flamewing/mdcomp/actions?query=workflow%3Aci-windows)
...
[![Windows snapshot build](https://img.shields.io/github/actions/workflow/status/flamewing/mdcomp/snapshots-windows.yml?branch=master&label=Windows%20Snapshot%20build&logo=windows&logoColor=white)](https://github.com/flamewing/mdcomp/actions?query=workflow%3Asnapshots-windows)
[![Latest Windows snapshot](https://img.shields.io/github/release-date/flamewing/mdcomp?label=Latest%20Windows%20snapshot&logo=windows&logoColor=white)](https://github.com/flamewing/mdcomp/releases/latest)
...
The src/asm directory is licensed under a bsd 0-Clause License (0BSD). Here is the [tl;dr version](https://tldrlegal.com/license/bsd-0-clause-license) of 0BSD.
...
The remainder is licensed under the GNU Lesser General Public License v3 (LGPL-3.0). Here is the [tl;dr version](https://tldrlegal.com/license/gnu-lesser-general-public-license-v3-(lgpl-3)) of LGPL-3.0.
